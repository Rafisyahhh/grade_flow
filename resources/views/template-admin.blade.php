    ...
    <div class="p-5">
        <div class="min-h-screen">
            ...
            <div class="relative font-poppins">
                <div class="fixed bg-primary shadow-md h-screen w-64 rounded-lg px-10 text-white">
                    <div>
                ...
                {{-- top bar --}}
                <div class="fixed top-5 right-5 left-72 bg-primary py-1 px-5 rounded-lg text-white shadow-md">
